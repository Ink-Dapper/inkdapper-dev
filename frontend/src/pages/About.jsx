    ...
    <div>
      ...
      <div className='my-2 md:my-10 flex flex-col md:flex-row gap-7 md:gap-16'>
        ...
        <div className='flex flex-col justify-center gap-2 md:w-2/4 text-gray-600'>
          ...
          <h3 className="header-visibility sr-only">Our Mission</h3>
          ...
          <h3 className="header-visibility sr-only">Our Promise</h3>
          ...
          <h3 className="header-visibility sr-only">Join the Ink Dapper Movement</h3>
      ...
      <h2 className="header-visibility sr-only">Why Choose Us</h2>
      <div className='flex flex-col md:flex-row text-sm mb-20'>
        <div className='border p-6 md:px-12 sm:py-20 flex flex-col gap-5'>
          <h3 className="header-visibility sr-only">Quality Assurance – Made to Last</h3>
        ...
        <div className='border p-6 md:px-12 sm:py-20 flex flex-col gap-5'>
          <h3 className="header-visibility sr-only">Convenience – Easy, Fast & Seamless</h3>
        ...
        <div className='border p-6 md:px-12 sm:py-20 flex flex-col gap-5'>
          <h3 className="header-visibility sr-only">Exceptional Customer Service – We’re Here for You</h3>
