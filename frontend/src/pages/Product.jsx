...
const Product = () => {
  ...
  const handleBuyNow = () => {
    if (!token) {
      ...
      toast.error('Please select product size to continue', {
        autoClose: 2000,
        pauseOnHover: false,
        transition: Flip
      })
      ...
      // Add item to cart first (required for place order page to work)
      const existingQuantity = cartItems[productData._id]?.[size] || 0;
      const newQuantity = existingQuantity + quantity;
      updateQuantity(productData._id, size, newQuantity);
      ...
      const itemText = quantity === 1 ? 'Item' : 'Items';
      toast.success(`Order is proceeding to checkout...`, {
        autoClose: 500, pauseOnHover: false,
        transition: Flip
      })

      // Navigate directly to place order page with minimal delay
      setTimeout(() => {
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12'>
            ...
            <div className='relative rounded-2xl shadow-sm border border-gray-100 overflow-hidden'>
              ...
              <div className='absolute top-4 right-4 flex flex-col gap-2 z-20'>
                <button
                  ...
                  className={`p-3 rounded-full shadow-xl transition-all duration-300 z-30 border-2 backdrop-blur-sm ${isWishlisted
                    ? 'bg-red-500 text-white border-red-500'
                    : 'bg-white/90 text-gray-700 hover:bg-white border-gray-300'
                    }`}
                >
                ...
                <button
                  ...
                  className='p-3 rounded-full bg-white/90 shadow-xl text-gray-700 hover:bg-white transition-all duration-300 z-30 border-2 border-gray-300 backdrop-blur-sm'
                >
          ...
          <div className='space-y-6'>
            ...
            <div className='space-y-4'>
              ...
              <div className='mt-4 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-4 border-2 border-yellow-200 shadow-sm'>
                <div className='flex items-start gap-3'>
                  ...
                  <div className='flex-1'>
                    <div className='flex items-center gap-2 mb-1'>
                      <span className='text-lg font-bold text-yellow-700'>Get 7% Off!</span>
                      <span className='px-2 py-1 bg-yellow-200 text-yellow-800 text-xs font-bold rounded-full'>
                        SAVE
                      </span>
                    </div>
                    <p className='text-sm text-gray-700 leading-relaxed'>
                      Buy more than one product or increase quantity to unlock discount
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className='mt-4 bg-gradient-to-r from-gray-50 to-orange-50 rounded-2xl p-4 border border-gray-200 shadow-sm'>
                <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                  <div className='flex flex-col items-center text-center space-y-2 p-3 bg-white rounded-xl border border-gray-100 hover:shadow-md transition-all duration-300'>
                    ...
                    <div>
                      ...
                      <p className='text-xs text-gray-600'>Online payments only</p>
                    </div>
                  </div>
