          ...
          <div className="border-t border-gray-200 p-3 md:p-4 flex-shrink-0">
            <form onSubmit={handleSendMessage} className="flex space-x-2">
              <input
                ...
                className="flex-1 px-3 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm text-slate-600"
                disabled={isTyping}
                autoComplete="off"
                autoCorrect="off"
