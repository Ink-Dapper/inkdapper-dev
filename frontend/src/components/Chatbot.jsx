...
const Chatbot = () => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed inset-4 md:bottom-24 md:right-6 md:inset-auto md:w-80 md:h-[70vh] w-[90%] h-[calc(90vh-2rem)] bg-white rounded-2xl shadow-2xl border border-gray-200 z-50 overflow-hidden flex flex-col">
          {/* Chat Header */}
