...
const ThemeToggle = () => {
  ...
  return (
    <>
      ...
      </button><span className="block md:hidden relative left-16 -top-1 !text-gray-700 dark:text-white text-[20px] text-white/80 group-hover:text-white transition-colors duration-300 mt-1">Theme</span>
    </>
  );
};
