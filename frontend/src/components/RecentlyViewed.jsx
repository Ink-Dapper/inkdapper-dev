...
const RecentlyViewed = () => {
  ...
  // Initialize arrow opacity when recent swiper is ready
  useEffect(() => {
    if (recentSwiperInstance) {
      ...
      if (prevButton) {
        prevButton.style.opacity = recentSwiperInstance.isBeginning ? '0.3' : '1';
      }
      if (nextButton) {
        nextButton.style.opacity = recentSwiperInstance.isEnd ? '0.3' : '1';
      }
    }
