      ...
      >
        <div className='transition-all duration-500 shadow-lg shadow-slate-200/30 hover:shadow-2xl hover:bright-shadow-multi rounded-2xl md:rounded-3xl overflow-hidden bg-white border border-slate-100/50'>
          ...
          <div className='card-info-section'>
            ...
            {/* Product Name */}
            <div className="flex items-start text-left mt-1">
              <h3
                className='product-name text-sm md:text-lg font-semibold text-slate-900 group-hover:text-orange-700 transition-colors duration-300 truncate w-full cursor-help'
                title={name}
              >
                {name}
              </h3>
