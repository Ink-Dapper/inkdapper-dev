    ...
    <>
      ...
      <div className="flex flex-col md:grid grid-cols-[3fr_1fr_1fr] gap-8 md:gap-14 my-10 mt-15 md:mt-20 text-sm">
        <div>
          ...
          <p className='w-full md:w-2/3 text-slate-600 text-xs md:text-base'>
        ...
        <div>
          ...
          <ul className='inline-flex flex-col gap-1 text-slate-600'>
            <Link onClick={() => scrollToTop()} to='/' className='hover:text-orange-600'>
              <li>Home</li>
            </Link>
            <Link onClick={() => scrollToTop()} to='/about' className='hover:text-orange-600'>
              <li>About Us</li>
            </Link>
            <Link onClick={() => scrollToTop()} to='/shipping-and-delivery' className='hover:text-orange-600'>
              <li>Shipping & Delivery</li>
            </Link>
            <Link onClick={() => scrollToTop()} to='/privacy-policy' className='hover:text-orange-600'>
              <li>Privacy Policy</li>
            </Link>
            <Link onClick={() => scrollToTop()} to='/terms-and-conditions' className='hover:text-orange-600'>
              <li>Terms & Conditions</li>
            </Link>
            <Link onClick={() => scrollToTop()} to='/cancellation-and-refund' className='hover:text-orange-600'>
          ...
          <div className='mt-5'>
            ...
            <div className='flex gap-8'>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className='text-slate-600 hover:text-orange-600 transition-colors duration-300'
                aria-label="Facebook"
              >
